...
CREATE TABLE [EmployeeSalary] (
  ...
  [Bonus] decimal(8,2),
  [TotalSalary] AS ([BaseSalary]+[Bonus]) persisted,
...
--create computed column totalsalary

--ALTER TABLE dbo.EmployeeSalary 
--ADD TotalSalary AS (BaseSalary + Bonus)
--GO
...
delete from Warehouse where City in ('Edmond')
INSERT INTO Warehouse 
(
    WarehouseID,
    EmployeeID,
